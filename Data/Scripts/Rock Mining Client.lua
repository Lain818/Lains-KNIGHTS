...
local miningXPplayerhas = player:GetResource("MiningExperience")
Task.Wait(1)
...
function FlyUpTextXP(amount, IDPos)
	if treePos == IDPos then
		UI.ShowFlyUpText("Mining + " .. amount .. " XP", treePos, {duration = 2, color = Color.GREEN, isBig = true})
	end
end
function CheckSkill()
	if Skill == nil then
