...
Module.titles = {
	{
		...
		extraHeight = 4,
		playerMUIDs = {
			"6049cafbafb94edb9415f8bb2c9793d2", --LainChan
			-- INSERT MUID HERE, SEE 1. ABOVE
		},
	},

	{
		name = "Friend of the Game",
		prefix = "Friend of the Game",
		prefixColor = Module.Color.GREEN,
		icon = script:GetCustomProperty("Friend"),
		iconColor = Module.Color.GREEN,
		isModerator = true,
		extraWidth = 4,
		extraHeight = 4,
		playerMUIDs = {
			"c861178ff5a940d7ba207cef648fb0d9",
			"37f0c29ec9cd4a0a84252b9ee73e2b19",
			"296300e8c34941fb9451833a80334975",
		},
	},

	{
		...
		extraHeight = 4,
		playerMUIDs = {
			"dd9c125567704261953ffd885e60a898", --Hani
...

	{
		...
		extraHeight = 4,
		playerMUIDs = {
			"1ef48c0383b54218be84280fc8e24fd6",
		},
	},
