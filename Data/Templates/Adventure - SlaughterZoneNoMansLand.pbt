Assets {
  Id: 7123267524780480829
  Name: "Adventure - SlaughterZoneNoMansLand"
  PlatformAssetType: 5
  TemplateAsset {
    ObjectBlock {
      ...
      Objects {
        ...
        UnregisteredParameters {
          Overrides {
            Name: "cs:ID"
            String: "EnemySlaughterNoMans"
          }
          Overrides {
            Name: "cs:Title"
            String: "Bold Skeletons"
          }
          Overrides {
            Name: "cs:Duration"
            Int: 10
          ...
          Overrides {
            Name: "cs:Description"
            String: "The Skeleton Army is getting bolder. Stop them in No Mans Lands."
          }
          Overrides {
          ...
          Overrides {
            ...
            String: "SlaughterEnemySkeletonsNoMans"
          }
          Overrides {
