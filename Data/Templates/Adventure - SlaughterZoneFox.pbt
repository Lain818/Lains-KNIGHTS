Assets {
  Id: 9662699421607840389
  Name: "Adventure - SlaughterZoneFox"
  PlatformAssetType: 5
  TemplateAsset {
    ObjectBlock {
      ...
      Objects {
        ...
        UnregisteredParameters {
          Overrides {
            Name: "cs:ID"
            String: "EnemySlaughterFox"
          }
          Overrides {
            Name: "cs:Title"
            String: "Help the people of Caves Market"
          }
          Overrides {
            Name: "cs:Duration"
            Int: 10
          ...
          Overrides {
            Name: "cs:Description"
            String: "Foxes are destroying all the crops in Caves Market garden. Go kill them!"
          }
          Overrides {
