Assets {
  Id: 6829136102597156184
  Name: "Adventure - SlaughterZoneRaptors"
  PlatformAssetType: 5
  TemplateAsset {
    ObjectBlock {
      ...
      Objects {
        ...
        UnregisteredParameters {
          Overrides {
            Name: "cs:ID"
            String: "EnemySlaughterRaptors"
          }
          Overrides {
            Name: "cs:Title"
            String: "Clean The Kingdom"
          }
          Overrides {
            Name: "cs:Duration"
            Int: 10
          ...
          Overrides {
            Name: "cs:Description"
            String: "The walls of the Kingdom are in danger. Beasts freely roam the plains."
          }
          Overrides {
          ...
          Overrides {
            ...
            String: "SlaughterEnemySkeletonsRaptors"
          }
          Overrides {
